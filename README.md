...
|------|------|
| 유동성 | 20일 평균 거래대금 ≥ $50M |
| RS 고점 근접 | SPY 대비 RS가 최근 50일 RS 최고값의 98% 이상 |
| RS 20D > 0 | 20일 SPY 대비 RS 변화율 양수 |
| MA50 위 + 상승 | 종가 > MA50, MA50이 10일 전보다 높음 |
| 50일 고점 근접 | 종가 ≥ 최근 50일 최고가의 90% |
| 과열 없음 | 종가 ≤ MA20×1.25, 5일 수익률 < 40%, 당일 수익률 < 25% |

**등급 A** — 위 조건 통과 + 거래량비율 ≥ 1.3배, 양봉, 종가위치 ≥ 60%  
**등급 B** — 위 조건 통과, 거래량 품질 미충족

**점수** — RS 20D(35%) + RS 50D(25%) + 50일 고점 근접도(20%) + 거래량비율(15%) + 종가위치(5%) percentile 가중합
